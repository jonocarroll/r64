...
* `r64::asm_patterns` defines the set of patterns for lexing/tokenising an ASM file
* Things to note:
    * upper or lower-case opcodes are allowed, but not mixed-case
    * hexadecimal bytes must always be written with 2 characters i.e `$01` not `$1`
...
* Custom R features
    * `.rbyte` directive. similar to the standard `.byte`, but the bytes come from the
      ...
      in the range 0-255.
    * `.rtext` directive. Similar to the stnadard `.text`, but the text comes from the 
